...
const ListFactures = () => {
    ...
    return (
        <div className='my-5 mx-24 '>
            <p>Mes factures</p>
            <div className='flex flex-col gap-2 md:grid grid-cols-2 lg:grid lg:grid-cols-3 mt-3 gap-6 '>

                <Dialog>
                    <DialogTrigger asChild className='cursor-pointer'>
                        <Button className='h-60 border-2 border-[#ff8600]  flex flex-col items-center justify-center ' variant="outline">
                ...
                {invoices.map((inv, i) => (
                    <div className=' bg-[#eaeaea] p-5 flex justify-between'>
                        <div>
                            <div>
                                {getStatus()}
                            </div>
