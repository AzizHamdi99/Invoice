                ...
                <div >
                    <Dialog>
                        <DialogTrigger asChild className='cursor-pointer'>
                            <Button className='h-32 w-90 border-2 border-[#ff8600]' variant="outline"><div className=' flex flex-col items-center justify-center  '>
                        ...
                        <DialogContent className="sm:max-w-md">
                            ...
                            <DialogFooter className="sm:justify-start">
                                <DialogClose asChild>
                                    <Button type="button" variant="secondary" disabled={name.length === 0} className='bg-[#ff8600]'>
                                        Create
                                    </Button>
                                </DialogClose>
                            </DialogFooter>
