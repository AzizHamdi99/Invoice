                ...
                <div className='flex flex-col gap-3 md:flex md:flex-row my-5 md:justify-between '>
                    ...
                    <div className='w-full flex flex-col gap-4'>
                        ...
                        <div className='p-5 border-2 border-dashed flex flex-col gap-4 rounded-md'>
                            <div
                                style={{ backgroundColor: '#ff8600', color: '#000000' }}
                                className='flex gap-2 w-fit px-3 py-1 rounded-md font-medium cursor-pointer'
                                onClick={downloadPDF}
                            >
                                Invoice PDF
                            ...
                            <div className='flex flex-col gap-5 px-5' ref={divRef}>
                                <div className='flex items-center justify-between'>
                                    <div>
                                        <div className='flex items-center gap-2 italic'>
                                            <Layers
                                                size={40}
                                                style={{ backgroundColor: '#000000', color: '#ff8600' }}
                                                className='rounded-full p-1'
                                            />
                                            <p className='text-2xl font-bold'>
                                                In<span style={{ color: '#ff8600' }}>Voice</span>
                                            </p>
                                        </div>
                                        <p className='uppercase text-6xl font-bold' style={{ color: '#1a2028' }}>
                                            INvoice
                                        </p>
                                    </div>

                                    <div className='uppercase flex flex-col gap-1.5'>
                                        <p style={{ backgroundColor: '#e7e7e7' }} className='px-2 py-0.5 rounded-xl w-fit'>
                                            invoice°{newInvoice?.id}
                                        </p>
                                        <p className='text-[18px]'>
                                            <span style={{ color: '#222328', fontWeight: 'bold' }}>Date:</span>{' '}
                                            {newInvoice?.createdAt ? formatDate(newInvoice?.createdAt) : 'Invalid date'}
                                        </p>
                                        <p className='text-[18px]'>
                                            <span style={{ color: '#222328', fontWeight: 'bold' }}>Due date:</span>{' '}
                                ...
                                <div className='flex items-center justify-between'>
                                    <div className='flex flex-col gap-1.5 items-start'>
                                        <p style={{ backgroundColor: '#e7e7e7', color: '#646568' }} className='px-4 py-0.5 rounded-xl w-fit'>
                                            Issuer
                                        </p>
                                        <p className='font-bold text-[18px]' style={{ color: '#222328' }}>{newInvoice?.seller}</p>
                                        <p style={{ color: '#8a8b8b' }}>{newInvoice?.sellerCompany}</p>
                                    </div>
                                    ...
                                    <div className='flex flex-col gap-1.5 items-end'>
                                        ...
                                        <p className='font-bold text-[18px]' style={{ color: '#222328' }}>{newInvoice?.buyer}</p>
                                        <p style={{ color: '#8a8b8b' }}>{newInvoice?.buyerCompany}</p>
                                    </div>
                                </div>

                                <div className='flex flex-col gap-3'>
                                    <div className='grid grid-cols-[1fr_2fr_2fr_2fr_2fr] border-b-[1px] p-3 font-semibold' style={{ color: '#7c8080' }}>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        {newInvoice?.lines?.map((item: any, i: number) => (
                                            <div
                                                key={i}
                                                className='grid grid-cols-[1fr_2fr_2fr_2fr_2fr] p-3 font-medium'
                                                style={{
                                                    backgroundColor: i % 2 !== 0 ? '#d9d9d9' : '#ffffff',
                                                    color: '#656565',
                                                }}
                                            >
                                                <p>{i + 1}</p>
                                ...
                                <div className='flex items-center justify-between my-4'>
                                    ...
                                    <div className='flex flex-col gap-2 text-[18px] font-semibold items-center'>
                                        ...
                                        <p className='rounded-xl px-2' style={{ backgroundColor: '#ff8600' }}>{newInvoice?.total}$</p>
                                    </div>
                                </div>
                            </div>
                        </div>
