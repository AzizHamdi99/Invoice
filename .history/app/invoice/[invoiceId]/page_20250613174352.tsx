                            ...
                            <div className='flex flex-col gap-5' >
                                <div className='flex items-center justify-between'>
                                    ...
                                    <div className='uppercase flex flex-col gap-1.5'>
                                        ...
                                        <p><span className='text-[#222328]'>Date:</span> {newInvoice?.createdAt ? formatDate(newInvoice?.createdAt) : "Invlide date"}</p>
                                        <p> <span className='text-[#222328]'> Due date: </span>{newInvoice?.dueDate ? formatDate(newInvoice?.dueDate) : "Invlide date"}</p>
