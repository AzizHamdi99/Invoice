                ...
                <div className='flex flex-col gap-3 md:flex md:flex-row my-5 '>
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-5 p-5 bg-[#eaeaea] rounded-md'>
                            ...
                            <input type="text" placeholder='Company name' className='bg-white p-3 rounded-xl outline-none' />
                    ...
                    <div>
                        <div className='flex flex-col gap-5 p-5 bg-[#eaeaea] rounded-md w-screen' >
                            <div className='flex items-center justify-between'>
