                    ...
                    <div className='flex flex-col gap-4'>
                        <div className='bg-[#eaeaea] p-5 rounded-md flex flex-col gap-2'>
                            <div className='flex items-center justify-between gap-4'>
                                <p className='text-sm bg-[#ff8600] px-2 px-0.5 rounded-md '>Summary of Totals</p>
                        ...
                        <div className='flex flex-col gap-3 p-5 bg-[#eaeaea] rounded-md'>
                            <p className='text-sm bg-[#ff8600] px-2 px-0.5 rounded-md '>Issuer</p>
                            <input type="text" placeholder='Company name' />
                            <textarea name="" id="" placeholder='Company Address'></textarea>
                            <p className='text-sm bg-[#ff8600] px-2 px-0.5 rounded-md '> Client</p>
