                            ...
                            <div className='flex flex-col gap-5' >
                                ...
                                <div className='flex items-center justify-between'>
                                    <div className='flex flex-col gap-1.5'>
                                        <p className='bg-[#e7e7e7] px-4 py-0.5 rounded-xl w-fit'>Issuer</p>
                                        <p className='text-[#222328] font-bold'>{newInvoice?.seller}</p>
                                        <p>{newInvoice?.sellerCompany}</p>

                                    </div>
                                    <div className='flex flex-col gap-1.5'>
                                        <p className='bg-[#e7e7e7] px-4 py-0.5 rounded-xl w-fit'>Client</p>
                                        <p className='text-[#222328] font-bold'>{newInvoice?.buyer}</p>
