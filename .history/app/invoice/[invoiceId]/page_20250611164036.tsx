                        ...
                        <div className='bg-[#eaeaea] p-5 rounded-md flex flex-col gap-2'>
                            <div className='flex items-center justify-between'>
                                ...
                                <div className='flex items-center gap-2'>
                                    <p>VAT(%)</p>
                                    <Switch className='bg-white border-[1px] border-black' onChange={() => setNewInvoice((prev) => {...Loader2, activeTva:!activetva})} />
                                    {!newInvoice?.active && <input className='w-17 p-1 bg-white rounded-full' type="number" />}
