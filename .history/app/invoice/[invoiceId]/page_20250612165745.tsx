                ...
                <div className='flex flex-col gap-2 md:flex md:justify-between md:flex-row my-5 '>
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className='flex flex-col gap-3 p-5 bg-[#eaeaea] rounded-md'>
                            ...
                            <input type="text" placeholder='Company name' className='bg-white p-3 rounded-md outline-none' />
                            <textarea name="" id="" placeholder='Company Address' className='bg-white p-3 rounded-md outline-none h-10'></textarea>
                            <p className='text-sm bg-[#ff8600] px-2 py-0.5 rounded-md w-fit  font-semibold'> Client</p>
                            <input type="text" placeholder=' Client name' className='bg-white p-3 rounded-md outline-none' />
                            <textarea name="" id="" placeholder='Client address' className='bg-white p-3 rounded-md outline-none h-10'></textarea>
