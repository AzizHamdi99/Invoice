...
const details = ({ params }: { params: { invoiceId: string } }) => {
    ...
    useEffect(() => {
        const changed = !isEqual(invoice, newInvoice); // we want to know if it's DIFFERENT
        setHasChanged(changed);
        console.log("Invoice changed?", changed);
    }, [invoice, newInvoice]);
            ...
            <div className='mx-4 lg:mx-32 my-6'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-2 md:gap-4'>
                        ...
                        <button className='flex items-center gap-4 px-5 py-1 rounded-md font-medium bg-[#ff8600] cursor-pointer' disabled={true}>
                            <p>Save</p>
                            <Save size={20} />
                        </button>
