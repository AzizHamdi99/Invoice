                            ...
                            <div className='flex flex-col gap-3 px-4'>
                                ...
                                {newInvoice?.lines.map((item: any, i: number) => (
                                    <div key={i} className='grid grid-cols-5 gap-5'>
                                        ...
                                        <input type="number" value={item?.quantity} className='bg-white rounded-md px-1 ' />
                                        <input type="text" value={item?.name} className='bg-white rounded-md px-1 ' />
                                        <input type="number" value={item?.unitPrice} className='bg-white rounded-md px-1 ' />
