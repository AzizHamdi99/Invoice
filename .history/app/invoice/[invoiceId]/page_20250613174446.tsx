                        ...
                        <div className='p-5 border-2 border-dashed flex flex-col gap-4'>
                            ...
                            <div className='flex flex-col gap-5' >
                                <div className='flex items-center justify-between'>
                                    ...
                                    <div className='uppercase flex flex-col gap-1.5 justify-end'>
                                        <p className='bg-[#e7e7e7] px-2 py-0.5 rounded-xl w-fit'>invoice°{newInvoice?.id}</p>
                                        <p><span className='text-[#222328] font-bold'>Date:</span> {newInvoice?.createdAt ? formatDate(newInvoice?.createdAt) : "Invlide date"}</p>
                                        <p> <span className='text-[#222328] font-bold'> Due date: </span>{newInvoice?.dueDate ? formatDate(newInvoice?.dueDate) : "Invlide date"}</p>
                                ...
                                <div className='flex flex-col gap-3'>
                                    <div className='grid grid-cols-[1fr_2fr_2fr_2fr_2fr] border-b-[1px] p-3'>
                                        <p>.</p>
                                        <p>Description</p>
                                        <p>Quantity</p>
                                        <p>Unit Price</p>
                                    ...
                                    <div className='flex flex-col gap-2'>
                                        {newInvoice?.lines?.map((item: any, i: number) => (
                                            <div key={i} className={`grid grid-cols-[1fr_2fr_2fr_2fr_2fr] p-3 ${i % 2 !== 0 ? "bg-[#d9d9d9]" : "bg-white"}`}>
                                                <p>{i + 1}</p>
                                                <p>{item?.name}</p>
                                                <p>{item?.quantity}</p>
                                                <p>{item?.unitPrice}</p>
