    ...
    return (
        <div>
            ...
            <div className='mx-4 lg:mx-32 my-6'>
                ...
                <div className='flex flex-col gap-2 md:flex md:justify-between md:flex-row my-5 xl:w-1/3'>
                    <div className='flex flex-col gap-2'>
                        <div className='bg-[#eaeaea] p-5 rounded-md flex flex-col gap-2'>
                            <div className='flex items-center justify-between'>
                                <p className='text-sm bg-[#ff8600] p-0.5 rounded-md '>Summary of Totals</p>
